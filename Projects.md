...
<div style="font-family: 'Alata';">
    ...
    <br>
    <span class="material-symbols-outlined" style="font-size: 13pt; color: #d6ac16;">construction</span>  
    <span style="font-size: small;">Skills used:</span><span style="color: gray; font-size: small;">  Python, C, delta-debugging, shell scripting, SLURM</span>
</div>
_____________
...
<div style="font-family: 'Alata';">
    ...
    <br>
    <span class="material-symbols-outlined" style="font-size: 13pt; color: #d6ac16;">construction</span>  
    <span style="font-size: small;">Skills used:</span><span style="color: gray; font-size: small;">  C, C++, compilers</span>
</div>
_____________
...
<div style="font-family: 'Alata';">
 ...
 <br> Supported by National Science Foundation <br> 2017 to 2019 <br></span>
    ...
    <br>
    <span class="material-symbols-outlined" style="font-size: 13pt; color: #d6ac16;">construction</span>  
    <span style="font-size: small;">Skills used:</span><span style="color: gray; font-size: small;">  C++, data structure analysis</span>
</div>
_____________
...
<div style="font-family: 'Alata';">
    ...
    <br>
    <span class="material-symbols-outlined" style="font-size: 13pt; color: #d6ac16;">construction</span>  
    <span style="font-size: small;">Skills used:</span><span style="color: gray; font-size: small;">  Java</span>
</div>
_____________
...
<div style="font-family: 'Alata';">
    ...
    <br>
    <span class="material-symbols-outlined" style="font-size: 13pt; color: #d6ac16;">construction</span>  
    <span style="font-size: small;">Skills used:</span><span style="color: gray; font-size: small;"> Java, code refactoring, code quality metrics</span>
</div>
_____________
